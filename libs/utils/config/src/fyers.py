...
LIVE_DATA_WEBSOCKET_BROADCAST_INTERVAL_MS = int(
    config.get("LIVE_DATA_WEBSOCKET_BROADCAST_INTERVAL_MS", 4000)
)
LIVE_DATA_RECONNECT_INITIAL_DELAY_SECONDS = float(
    config.get("LIVE_DATA_RECONNECT_INITIAL_DELAY_SECONDS", 1.0)
)
LIVE_DATA_RECONNECT_MAX_DELAY_SECONDS = float(
    config.get("LIVE_DATA_RECONNECT_MAX_DELAY_SECONDS", 60.0)
)

# Token watcher configuration
TOKEN_WATCHER_POLL_INTERVAL_SECONDS = int(
    config.get("TOKEN_WATCHER_POLL_INTERVAL_SECONDS", 30)
)
