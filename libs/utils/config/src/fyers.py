...
# COI Live configuration
COI_LIVE_STRIKE_COUNT = int(config.get("COI_LIVE_STRIKE_COUNT", 4))
COI_LIVE_START_HOUR = int(config.get("COI_LIVE_START_HOUR", 9))
COI_LIVE_START_MINUTE = int(config.get("COI_LIVE_START_MINUTE", 15))
COI_LIVE_INTERVAL_MINUTES = int(config.get("COI_LIVE_INTERVAL_MINUTES", 5))
