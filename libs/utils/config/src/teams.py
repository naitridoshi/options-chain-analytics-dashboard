...
MS_TEAMS_WEBHOOK_ENABLED = str(
    config.get("MS_TEAMS_WEBHOOK_ENABLED", "false")
).lower()
...
MS_TEAMS_DEBUG_ALERTS_WEBHOOK_URL = config.get(
    "MS_TEAMS_DEBUG_ALERTS_WEBHOOK_URL"
)
MS_TEAMS_INFO_ALERTS_WEBHOOK_URL = config.get(
    "MS_TEAMS_INFO_ALERTS_WEBHOOK_URL"
)
MS_TEAMS_ERROR_ALERTS_WEBHOOK_URL = config.get(
    "MS_TEAMS_ERROR_ALERTS_WEBHOOK_URL"
)
MS_TEAMS_WARNING_ALERTS_WEBHOOK_URL = config.get(
